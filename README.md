...
> 如果你想让 Claude Code 做更多 Obsidian 操作（搜索、创建、移动笔记等），推荐安装 [kepano/obsidian-cli skill](https://github.com/kepano/obsidian-cli)。装上后 CC 就能直接学会 Obsidian CLI 的各种用法，这个 Hook 只是个抛砖引玉。
> If you want Claude Code to do more with Obsidian (search, create, move notes, etc.), try [kepano/obsidian-cli skill](https://github.com/kepano/obsidian-cli). This hook is just a starting point。
